...
Scenario: Add a new company
  ...
  When I select "portfolio" from "company_type"
  And I fill in "name" with "Cutesy"
  And I fill in "representative_role" with "Cutie"
  And I fill in "representative_id" with "2"
  And I press "Create"
  Then I should be on the home page
  And I should see "Success!"
